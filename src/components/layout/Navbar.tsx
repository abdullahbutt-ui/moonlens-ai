...
const Navbar = () => {
  ...
  const showBackButton = !isOnDashboard && location.pathname !== '/auth' && location.pathname !== '/login' && location.pathname !== '/landing' && location.pathname !== '/' && user;
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent className="w-56 bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-700" align="end" forceMount>
                  ...
                  <DropdownMenuItem 
                    ...
                    className="cursor-pointer text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800"
                  >
