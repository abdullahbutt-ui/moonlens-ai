...
const CurrentMood = ({ emotion, confidence, isDetecting }: CurrentMoodProps) => {
  return (
    <Card className="bg-gradient-to-br from-purple-50 to-blue-50 dark:from-purple-900/30 dark:to-blue-900/30 border-purple-200 dark:border-purple-500/30">
      <CardHeader>
      ...
      <CardContent className="text-center">
        <div className="mb-4">
          ...
          <h3 
            className="text-2xl font-bold capitalize mb-2 dark:text-white"
