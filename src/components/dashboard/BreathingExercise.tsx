...
const BreathingExercise = ({
  ...
  const exercises = {
    ...
    '4-2-6': {
      ...
      exhale: 6,
      name: 'Calm Breathing',
      description: 'Gentle technique for anxiety'
    }
  };
  ...
  const quotes = ["Breathe in peace, breathe out stress.", "Your breath is your anchor to the present moment.", "With each breath, you create space for calm.", "Breathing deeply brings clarity to the mind.", "Let your breath guide you to serenity."];
      ...
      <DialogContent className="max-w-md w-full mx-auto bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-700 rounded-3xl px-4 py-6">
        <DialogHeader>
          <div className="flex items-center justify-between">
            ...
            <Button variant="ghost" size="sm" onClick={() => setIsOpen(false)} className="text-gray-500 dark:text-gray-400">
        ...
        <div className="space-y-6 max-h-[70vh] overflow-y-auto flex flex-col items-center w-full px-2">
          {/* Exercise Selection */}
          ...
          {/* Breathing Circle */}
          <div className="flex flex-col items-center space-y-6 py-4 w-full max-w-sm">
            <div className="relative w-40 h-40 sm:w-48 sm:h-48 flex items-center justify-center mx-auto">
              <motion.div className={`w-32 h-32 rounded-full bg-gradient-to-br ${getPhaseColor()} flex items-center justify-center shadow-lg`} animate={{
              ...
              ease: "easeInOut"
                ...
                <div className="text-white text-center">
                  <motion.div className="text-lg font-semibold capitalize mb-1" key={phase} initial={{
                  opacity: 0,
                  y: 10
                }} animate={{
                  opacity: 1,
                  ...
                  <motion.div className="text-3xl font-bold" key={counter} initial={{
                  scale: 1.2,
                  opacity: 0
                }} animate={{
                  scale: 1,
            ...
            <div className="flex flex-wrap gap-2 justify-center w-full max-w-sm">
              <Button onClick={startExercise} disabled={isActive} className="bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 text-white rounded-full px-4 py-2 text-sm">
                <Play className="w-3 h-3 mr-1" />
                Start
              </Button>
              <Button onClick={pauseExercise} disabled={!isActive} variant="outline" className="border-blue-300 dark:border-blue-500 text-blue-600 dark:text-blue-400 rounded-full px-4 py-2 text-sm">
                <Pause className="w-3 h-3 mr-1" />
                Pause
              </Button>
              <Button onClick={resetExercise} variant="outline" className="border-gray-300 dark:border-gray-600 text-gray-600 dark:text-gray-400 rounded-full px-4 py-2 text-sm">
            ...
            <div className="text-center text-gray-700 dark:text-gray-300 w-full max-w-sm space-y-4 px-4">
              <motion.p className="text-lg font-medium capitalize" key={`${phase}-${counter}`} initial={{
              opacity: 0,
              y: 5
            }} animate={{
              opacity: 1,
