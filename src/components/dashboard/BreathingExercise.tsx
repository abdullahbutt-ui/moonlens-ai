        ...
        <div className="space-y-6 max-h-[70vh] overflow-y-auto flex flex-col items-center w-full">
          ...
          <div className="flex flex-col items-center space-y-6 py-4 w-full">
            ...
            <div className="flex gap-3 justify-center w-full">
              <Button onClick={startExercise} disabled={isActive} className="bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 text-white rounded-full px-6 py-2">
                <Play className="w-4 h-4 mr-2" />
                Start
              </Button>
              <Button onClick={pauseExercise} disabled={!isActive} variant="outline" className="border-blue-300 dark:border-blue-500 text-blue-600 dark:text-blue-400 rounded-full px-6 py-2">
                <Pause className="w-4 h-4 mr-2" />
                Pause
              </Button>
              <Button onClick={resetExercise} variant="outline" className="border-gray-300 dark:border-gray-600 text-gray-600 dark:text-gray-400 rounded-full px-6 py-2">
