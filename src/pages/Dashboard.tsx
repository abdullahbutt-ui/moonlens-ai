              ...
              <div className="bg-white/80 dark:bg-black/50 backdrop-blur-sm p-4 sm:p-6 rounded-xl shadow-sm border border-gray-200 dark:border-purple-500/20">
                ...
                <div className="space-y-3 sm:space-y-4">
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600 dark:text-gray-400 text-sm sm:text-base">Current Streak</span>
                    <span className="text-orange-600 dark:text-orange-400 font-semibold">{checkInStreak} days</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600 dark:text-gray-400 text-sm sm:text-base">Weekly Challenges</span>
                    <span className="text-teal-600 dark:text-teal-400 font-semibold">
                      {weeklyChallenges.filter(c => c.completed).length}/{weeklyChallenges.length}
                    </span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600 dark:text-gray-400 text-sm sm:text-base">Audio Sessions</span>
